...
namespace ShellToolForSQLServer.Dao
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static string ValidateSQL(string connectionString, string cmdText)
        {
            string strResult = "OK";
        ...
        public static string ValidateSQL(string connectionString, string[] cmdText)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    foreach (var sqlText in cmdText)
                    {
        ...
        public static string Restore(string connectionString, string cmdText)
        {
            string strResult = "OK";
        ...
        public static DataTable GetDataTable(string connectionString, CommandType cmdType, string cmdText,
            params SqlParameter[] commandParameters)
        {
